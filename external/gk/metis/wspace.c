...
void AllocateRefinementWorkSpace(ctrl_t* ctrl, idx_t nbrpoolsize_max, idx_t nbrpoolsize) {
    ...
    case METIS_OBJTYPE_CUT:
        ctrl->cnbrpool = (cnbr_t*)gk_malloc(ctrl->nbrpoolsize * sizeof(cnbr_t), "AllocateRefinementWorkSpace: cnbrpool");
        break;

    case METIS_OBJTYPE_VOL:
        ctrl->vnbrpool = (vnbr_t*)gk_malloc(ctrl->nbrpoolsize * sizeof(vnbr_t), "AllocateRefinementWorkSpace: vnbrpool");
        break;
...
idx_t cnbrpoolGetNext(ctrl_t* ctrl, idx_t nnbrs) {
    ...
    if(ctrl->nbrpoolcpos > ctrl->nbrpoolsize) {
        ...
        ctrl->cnbrpool = (cnbr_t*)gk_realloc(ctrl->cnbrpool, ctrl->nbrpoolsize * sizeof(cnbr_t), "cnbrpoolGet: cnbrpool");
...
idx_t vnbrpoolGetNext(ctrl_t* ctrl, idx_t nnbrs) {
    ...
    if(ctrl->nbrpoolcpos > ctrl->nbrpoolsize) {
        ...
        ctrl->vnbrpool = (vnbr_t*)gk_realloc(ctrl->vnbrpool, ctrl->nbrpoolsize * sizeof(vnbr_t), "vnbrpoolGet: vnbrpool");
        ctrl->nbrpoolreallocs++;
    }
