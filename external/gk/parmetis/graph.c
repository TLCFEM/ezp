...
void FreeGraph(graph_t* graph) {
    ...
    gk_free((void**)&graph->xadj, (void**)&graph->vwgt, (void**)&graph->nvwgt, (void**)&graph->vsize, (void**)&graph->adjncy, (void**)&graph->adjwgt, (void**)&graph->vtxdist, (void**)&graph->home, LTERM);
...
void FreeInitialGraphAndRemap(graph_t* graph) {
    ...
    gk_free((void**)&graph->nvwgt, &graph->home, &graph->lnpwgts, &graph->gnpwgts, LTERM);
