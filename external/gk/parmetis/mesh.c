 ...
 **************************************************************************/
int ParMETIS_V3_Mesh2Dual(idx_t* elmdist, idx_t* eptr, idx_t* eind, idx_t* numflag, idx_t* ncommon, idx_t** r_xadj, idx_t** r_adjncy, MPI_Comm* comm) {
    idx_t i, j, jj, k, kk, m;
    ...
    gkMPI_Alltoallv((void*)nodelist, scounts, sdispl, IDX_T, (void*)recvbuffer, rcounts, rdispl, IDX_T, *comm);
    ...
    gkMPI_Alltoallv((void*)sbuffer, scounts, sdispl, IDX_T, (void*)rbuffer, rcounts, rdispl, IDX_T, *comm);
    ...
    gk_free((void**)&nodedist, &nodelist, &auxarray, &htable, &scounts, &rcounts, &sdispl, &rdispl, &nmap, &recvbuffer, &gnptr, &gnind, &sbuffer, &rbuffer, &nptr, &ind, &wgt, LTERM);
