...
void MUMPS_CALL
MUMPS_LOW_LEVEL_INIT_OOC_C(MUMPS_INT* _myid, MUMPS_INT* total_size_io, MUMPS_INT* size_element, MUMPS_INT* async, MUMPS_INT* keep211, MUMPS_INT* nb_file_type, MUMPS_INT* flag_tab, MUMPS_INT* keep255, MUMPS_INT* ierr) {
    ...
    *ierr = (MUMPS_INT)mumps_init_file_name(MUMPS_OOC_STORE_TMPDIR, MUMPS_OOC_STORE_PREFIX, &MUMPS_OOC_STORE_TMPDIRLEN, &MUMPS_OOC_STORE_PREFIXLEN, &myid_loc);
    if(*ierr < 0) {
        free(flag_tab_loc);
        return;
    }
    ...
    *ierr = (MUMPS_INT)mumps_init_file_structure(&myid_loc, &total_size_io_loc, &size_element_loc, &nb_file_type_loc, flag_tab_loc, *keep255);
    free(flag_tab_loc);
    if(*ierr < 0) {
        return;
    }
 ...
 */
void MUMPS_CALL
MUMPS_LOW_LEVEL_WRITE_OOC_C(const MUMPS_INT* strat_IO, void* address_block, MUMPS_INT* block_size_int1, MUMPS_INT* block_size_int2, MUMPS_INT* inode, MUMPS_INT* request_arg, MUMPS_INT* type, MUMPS_INT* vaddr_int1, MUMPS_INT* vaddr_int2, MUMPS_INT* ierr) {
 ...
 */
void MUMPS_CALL
MUMPS_LOW_LEVEL_READ_OOC_C(const MUMPS_INT* strat_IO, void* address_block, MUMPS_INT* block_size_int1, MUMPS_INT* block_size_int2, MUMPS_INT* inode, MUMPS_INT* request_arg, MUMPS_INT* type, MUMPS_INT* vaddr_int1, MUMPS_INT* vaddr_int2, MUMPS_INT* ierr) {
    char buf[64]; /* for error message */
    long long vaddr, block_size;
    MUMPS_INT inode_loc, request_arg_loc, type_loc, ierr_loc, strat_IO_loc;
#if !defined(MUMPS_WIN32)
...
void MUMPS_CALL
MUMPS_LOW_LEVEL_DIRECT_READ(void* address_block, MUMPS_INT* block_size_int1, MUMPS_INT* block_size_int2, MUMPS_INT* type, MUMPS_INT* vaddr_int1, MUMPS_INT* vaddr_int2, MUMPS_INT* ierr) {
    /*  MUMPS_INT ret_code=0; */
    long long vaddr, block_size;
...
void MUMPS_CALL
MUMPS_OOC_SET_FILE_NAME_C(MUMPS_INT* type, MUMPS_INT* indice, MUMPS_INT* length, MUMPS_INT* ierr, char* name, mumps_ftnlen l1) {
    MUMPS_INT type_loc, indice_loc, length_loc;
    type_loc = (MUMPS_INT)*type;
    indice_loc = (MUMPS_INT)*indice;
...
void MUMPS_CALL
MUMPS_OOC_INIT_VARS_C(MUMPS_INT* myid_arg, MUMPS_INT* size_element, MUMPS_INT* async, MUMPS_INT* keep211, MUMPS_INT* keep255, MUMPS_INT* ierr) {
...
mumps_convert_2fint_to_longlong(MUMPS_INT* short_int1, MUMPS_INT* short_int2, long long* long_int) {
