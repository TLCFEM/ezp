...
*/
    ...
    if(*weightrequested == 1) {
        ...
        *ncmpa = -1;
        ...
        return;
#else
        *ncmpa = esmumpsvc(*n, *iwlen, petab, *pfree, lentab, iwtab, nvtab, elentab, lasttab, contextptr);
#endif
#else
        ...
        *ncmpa = -1;
        ...
        return;
#else
        *ncmpa = esmumpsc(*n, *iwlen, petab, *pfree, lentab, iwtab, nvtab, elentab, lasttab, contextptr);
#endif
#else
