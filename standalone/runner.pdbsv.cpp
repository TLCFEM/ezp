 ...
 ******************************************************************************/
/**
 * @brief Example caller to the standalone `pdbsv` solver.
 *
 * @author tlc
 * @date 07/03/2025
 * @version 1.0.0
 * @file runner.pdbsv.cpp
 * @{
 */
...
int main(int argc, char* argv[]) {
    ...
    const auto worker = comm_world.spawn(0, NUM_NODE, {"solver.pdbsv"});
    ...
    std::vector<double> A(N * (KL + KU + 1), 0.), B(N * NRHS, 1.);
